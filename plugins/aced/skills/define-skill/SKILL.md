...
```bash
npx cyberplace@0.2.2 governance show skill-design   # resolve <version> via: npm view cyberplace version — never @latest
```
...
```bash
npx cyberplace@0.2.2 audit validate --path <placement-dir>/<name>
```
