...
```bash
npx cyberplace@0.2.1 governance show skill-design   # resolve <version> via: npm view cyberplace version — never @latest
```
...
```bash
npx cyberplace@0.2.1 audit validate --path <placement-dir>/<name>
```
