...
Upgrades all pinned `npx universal-plugin@0.2.2` calls across a project to the latest or a specific version.
...
2. Finds every `npx universal-plugin@0.2.2` occurrence across the project
