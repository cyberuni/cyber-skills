...
Background research informing how `cyberplace` CLI should format output for agent consumers. Relevant to `agent-tool-output` governance and [ADR-0004](../../artifacts/adr/0004-cyberplace-cli-output.md).
...
`--format json` adopted as the machine-output flag for all dual-audience `cyberplace` CLI commands. `--json` kept as a hidden backward-compat alias. See [ADR-0004](../../artifacts/adr/0004-cyberplace-cli-output.md).
