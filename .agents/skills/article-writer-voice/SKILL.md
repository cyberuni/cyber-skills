...
description: "Use this skill when drafting, rewriting, or polishing long-form writing in Homa Wong's (unional's) voice — blog posts, tutorials, guides, release notes, READMEs, newsletter issues, and project docs. Trigger on \"write a post\", \"draft an article\", \"turn this into a blog\", \"make it sound like me\", or any prose longer than a paragraph where voice consistency matters."
metadata:
  internal: true
---
...
This skill writes prose in an established voice. It does not own doc placement,
...
- **At most one emoji, at the sign-off, and only in personal register.** Never in
  docs. A single sign-off emoji is fine to close a tutorial; mid-paragraph emoji
  are not.
